...
public class SimpleLogAspect {
    @Pointcut("@annotation(net.btnz.pri.java.myspringbootbasetest.springbootbasetest.aspect.simple.Anno)")
...
//    }
    @Before("execution(* net.btnz.pri.java.myspringbootbasetest.springbootbasetest.aspect.simple.DemoMethodService.*(..))")
